...
import { ArrowRight, Check, Phone, User, Calendar } from "lucide-react"
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] w-full">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center py-32 md:py-4">
          ...
          <ScrollAnimation variant={fadeInUp} delay={0.2}>
            <p className="text-base sm:text-lg md:text-xl text-white mb-6 md:mb-8 max-w-2xl">
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <motion.div key={product.id} variants={fadeInUp}>
                <div
                  className={`product-card ${product.stars === 3 ? "three-star" : product.stars === 2 ? "two-star" : "one-star"} h-full shadow-md`}
                >
                  ...
                  <div className="content h-full flex flex-col">
                    ...
                    <div className="flex justify-between items-center mt-4">
                      ...
                      <Link href={`/products/${product.id}`} className="flex items-center text-primary hover:underline">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <ScrollAnimation variant={fadeInLeft}>
              <div>
                ...
                <StaggerContainer className="space-y-3 mb-6 md:mb-8">
            ...
            <ScrollAnimation variant={fadeInRight} className="mt-6 lg:mt-0">
      ...
      <section className="py-10 md:py-16 bg-primary">
        <div className="container mx-auto px-4">
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center text-white">
            {[
              ...
              <motion.div key={index} variants={zoomIn} className="px-2">
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <ScrollAnimation variant={slideIn}>
            <div className="bg-gray-100 rounded-lg p-6 sm:p-8 md:p-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
                ...
                <ScrollAnimation variant={fadeInRight} delay={0.3} className="mt-4 md:mt-0">
