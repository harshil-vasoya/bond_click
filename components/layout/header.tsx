              ...
              <ul className="flex items-center">
                ...
                <li className="group relative px-1">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={14}
                      className={`ml-1.5 transition-transform duration-300 ${activeDropdown === "products" ? "rotate-180" : ""}`}
                    />
                    <span
                      className={`absolute inset-x-3 bottom-1.5 h-[2px] origin-left transform transition-transform duration-300 ${
                        isActive("/products")
                ...
                <li className="ml-3">
                  <Link
                    href="/contact-us"
                    className={`relative overflow-hidden group ${isActive("/contact-us") ? "ring-1 ring-primary" : ""}`}
                  >
                    <motion.span
